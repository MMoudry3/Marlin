...
#define STRING_CONFIG_H_AUTHOR "(mmoudry)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-5 Plus, auto tune result of: M303 E0 S225 C10
    ...
    #define DEFAULT_Kp 21.6794
    #define DEFAULT_Ki 1.6573
    #define DEFAULT_Kd 70.8999
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 200 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 27.5451
  #define DEFAULT_bedKi 5.3799
  #define DEFAULT_bedKd 94.0206
#endif // PIDTEMPBED
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 82.90, 80.81, 800, 139.36 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 4000, 4000, 15, 7500 }
...
#define NOZZLE_TO_PROBE_OFFSET_X -64
#define NOZZLE_TO_PROBE_OFFSET_Y -2
#define NOZZLE_TO_PROBE_OFFSET { NOZZLE_TO_PROBE_OFFSET_X, NOZZLE_TO_PROBE_OFFSET_Y, -2.490 }
...
//#define SKEW_CORRECTION
  ...
  */
  #define XY_DIAG_AC 146.11*2‬
  #define XY_DIAG_BD 142.96*2
  #define XY_SIDE_AD 103.66*2
